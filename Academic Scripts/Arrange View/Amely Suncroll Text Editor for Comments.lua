...
gfx.init("Text Editor for Comments (beta 0.2.4)", startWidth, startHeight, dock_state, x, y)
...
local function handle_input(char, ctrl, shift)
  if ctrl and not shift and char == 26 then -- Ctrl + z
      undo()
  elseif ctrl and shift and char == 26 then -- Ctrl + Shift + z
      ...
      elseif char == 127 then -- Delete key
          delete_selection()
