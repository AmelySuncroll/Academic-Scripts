-- @description Delete selected chords except the lowest note
-- @author Amely Suncroll
-- @version 1.0
-- @website https://forum.cockos.com/showthread.php?t=291012
-- @changelog
--    + init @
-- @about Delete selected chords except the lowest note
...
function main()
    ...
    reaper.Undo_OnStateChange("Delete all notes in selected chords except the lowest note")
end

reaper.Undo_BeginBlock()
main()
reaper.Undo_EndBlock("Delete selected chords except the lowest note", -1)
