...
local translations = {
    en = {
        ...
        press_enter_to_start_new_game = "Enter  -  new game",
        press_c_to_continue = "C  -  continue",
...
--[[
function load_maze_settings()
    local file = io.open(reaper.GetResourcePath() .. "/Robomaze_settings.txt", "r")

    if file then
        maze_difficulty_is = file:read("*l")
        total_heart = tonumber(file:read("*l"))
        is_easy_m = file:read("*l") == 'true'
        is_medium_m = file:read("*l") == 'true'
        is_hard_m = file:read("*l") == 'true'
        is_impo_m = file:read("*l") == 'true'
        current_language = file:read("*l")
        is_us_lang = current_language == "en"
        file:close()
    else
        maze_difficulty_is = "medium"
...
function draw_new_game_screen()
    ...
    gfx.setfont(2, "Iregula", 20) -- sub_message
    local sub_text_width = gfx.measurestr(sub_message)
    gfx.x = (gfx.w - sub_text_width) / 2
...
function draw_footer()
    ...
    if current_level == 1 then
        ...
        footer_message = "Use arrow keys to navigate and find finish"
        footer()
    end
...
function handle_keypress()
    ...
    elseif game_state == "menu" and key == 13 then  -- enter, hello screen
        game_state = "new_game"
    ...
    elseif game_state == "new_game" and key == 13 then  -- enter, new game
        ...
        load_level(1)
        i_found_heart = total_heart
    elseif game_state == "menu" and key == 99 then  -- c, continue game
    ...
    elseif game_state == "playing" and key == 114 then -- r, test
