-- @description Create send to HALL
...
local targetTrackName = "Hall"  -- change it to "Delay", "Room", "Stage" or other track names you want

local retval, sendVolume_dB_str = reaper.GetUserInputs("Set Send Volume to Hall", 1, "Send Volume in dB:", "0.00")
