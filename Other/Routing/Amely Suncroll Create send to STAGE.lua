-- @description Create send to STAGE
...
-- @about Create send to folder named 'STAGE' (you can change name inside the code)
...
local targetTrackName = "Stage"  -- change it to "Delay", "Room", "Stage" or other track names you want

local retval, sendVolume_dB_str = reaper.GetUserInputs("Set Send Volume to Stage", 1, "Send Volume in dB:", "0.00")
