-- @description Create send to Track 02
...
local retval, sendVolume_dB_str = reaper.GetUserInputs("Set Send Volume to Track 02", 1, "Send Volume in dB:", "0.00")
...
local firstTrack = reaper.GetTrack(0, 1) 
