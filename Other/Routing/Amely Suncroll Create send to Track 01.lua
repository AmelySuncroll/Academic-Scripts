...
-- @about Create send to the FIRST track (include folders)
...
local retval, sendVolume_dB_str = reaper.GetUserInputs("Set Send Volume to Track 01", 1, "Send Volume in dB:", "0.00")
